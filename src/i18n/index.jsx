...
const en = {
  ...
  'orbit.title': 'Photograph the dish',
  'orbit.hint': 'One photo works. Four, taken while you walk around the plate, give the reconstruction real geometry instead of a guess.',
  'orbit.count': '{taken} of {total}',
  'orbit.view.front': 'Front',
  'orbit.view.right': 'Right',
  'orbit.view.back': 'Back',
  'orbit.view.left': 'Left',
  'orbit.choose': 'Choose from gallery',
  'orbit.buildOne': 'Build the dish',
  'orbit.buildMulti': 'Build from {taken} views',
  'orbit.ignored': 'The on-device engine uses one photo. Pick a reconstruction engine and add a key to use all the views you took.',
  ...
  'upload.tips.4': 'One photo: shoot straight down. Four: hold the camera at plate height and step a quarter turn between each.',
  ...
  'action.back': 'Back',
  'action.apply': 'Apply',
  'action.adjustCutout': 'Adjust cut-out',
  'action.adjustShape': 'Adjust shape',
  ...
  'engine.label': 'How to build the 3D dish',
  'engine.inflate': 'On device',
  'engine.key': 'API key',
  'engine.keyWarning': 'The key is stored in this browser and sent straight to the service, so anyone who can open this page on this device can use it. Move it behind your own server before a restaurant touches this.',
  'model.yaw': 'Turn',
  'model.aiNote': 'Geometry comes from the reconstruction. Only its size, facing and plate are adjustable here.',
  'status.ai.upload': 'Sending the photo…',
  'status.ai.queued': 'Waiting in the queue…',
  'status.ai.generating': 'Reconstructing in 3D…',
  'status.ai.download': 'Downloading the model…',
  'status.assembling': 'Placing the dish…',
...
const ar = {
  ...
  'orbit.title': 'صوّر الطبق',
  'orbit.hint': 'صورة واحدة تكفي. أربع صور أثناء دورانك حول الطبق تمنح إعادة البناء شكلًا حقيقيًا بدل التخمين.',
  'orbit.count': '{taken} من {total}',
  'orbit.view.front': 'الأمام',
  'orbit.view.right': 'اليمين',
  'orbit.view.back': 'الخلف',
  'orbit.view.left': 'اليسار',
  'orbit.choose': 'اختر من المعرض',
  'orbit.buildOne': 'ابنِ الطبق',
  'orbit.buildMulti': 'ابنِ من {taken} صور',
  'orbit.ignored': 'المحرك على الجهاز يستخدم صورة واحدة. اختر محرك إعادة بناء وأضف مفتاحًا لاستخدام كل الصور.',
  ...
  'upload.tips.4': 'صورة واحدة: صوّر من الأعلى. أربع صور: أبقِ الكاميرا بمستوى الطبق وتحرك ربع دورة بين كل صورة.',
  ...
  'action.back': 'رجوع',
  'action.apply': 'تطبيق',
  'action.adjustCutout': 'تعديل القص',
  'action.adjustShape': 'تعديل الشكل',
  'action.next': 'متابعة',
  'action.delete': 'حذف',
  ...
  'engine.label': 'طريقة بناء الطبق ثلاثي الأبعاد',
  'engine.inflate': 'على الجهاز',
  'engine.key': 'مفتاح الواجهة البرمجية',
  'engine.keyWarning': 'يُحفظ المفتاح في هذا المتصفح ويُرسل مباشرة إلى الخدمة، لذا يمكن لأي شخص يفتح هذه الصفحة على هذا الجهاز استخدامه. انقله خلف خادمك الخاص قبل استخدامه في مطعم.',
  'model.yaw': 'الدوران',
  'model.aiNote': 'الشكل ناتج عن إعادة البناء. يمكن تعديل الحجم والاتجاه والصحن فقط هنا.',
  'status.ai.upload': 'جارٍ إرسال الصورة…',
  'status.ai.queued': 'في قائمة الانتظار…',
  'status.ai.generating': 'جارٍ إعادة البناء ثلاثي الأبعاد…',
  'status.ai.download': 'جارٍ تنزيل النموذج…',
  'status.assembling': 'جارٍ وضع الطبق…',
